...
- Create a "Daily Briefing" tab that gives users a quick overview of clusters of news from the past 24 hours
    - Full body articles in Daily Gradient, with option to expand text as well as current links to full article page

Next Steps:
- Add in full article link on search results, possibly using Wayne's intermediary screen template
